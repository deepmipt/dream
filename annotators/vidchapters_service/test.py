...
def test_exec_time():
    video_path = "http://files:3000/file?file=file_228.mp4"
    test_data = { "video_path": [video_path], "video_durations": [59], "video_types": ['.mp4']}    
...
def test_execution():
    video_path = "http://files:3000/file?file=file_228.mp4"
    gold_result = "[{'sentence': 'Intro.', 'timestamp': [0.0, 10.727636363636364]}, {'sentence': 'Showing impressive award combinations.', 'timestamp': [10.727636363636364, 30.3949696969697]}, {'sentence': 'Discussing who won an Oscar and a gold medal.', 'timestamp': [30.3949696969697, 59.002]}]"
    test_data = { "paths": [video_path], "durations": [59], "types": ['.mp4']}
    result = requests.post(url, json=test_data)
